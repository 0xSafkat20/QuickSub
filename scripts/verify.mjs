...
if(process.argv.includes('--browser'))steps.push(...[['browser-cart','scripts/check-cart.mjs'],['browser-sessions','scripts/check-session-expiry.mjs'],['browser-reporting','scripts/check-reporting.mjs'],['browser-password-recovery','scripts/check-password-recovery.mjs'],['browser-navigation','scripts/check-navigation.mjs'],['browser-responsive','scripts/check-responsive.mjs'],['browser-accounts','scripts/check-accounts.mjs'],['browser-checkout','scripts/check-checkout.mjs'],['browser-payments','scripts/check-payments.mjs'],['browser-admin','scripts/check-admin.mjs'],['browser-chat','scripts/check-chat.mjs'],['browser-privacy','scripts/check-privacy.mjs'],['browser-storefront','scripts/check-storefront.mjs']].map(([name,path])=>[name,['node',path]]));
