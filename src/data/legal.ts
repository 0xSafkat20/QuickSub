...
export const legalDocuments: Record<string, LegalDocument> = {
  ...
  'Privacy Policy': {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Account authentication is handled by Supabase Auth. Saved names, contact details, reminder preferences, and linked orders are stored in our Supabase database. Server-side sessions expire after one hour or when you sign out. Order-related data is retained for fulfillment, support, and dispute resolution.',
      },
      {
        heading: 'Your Rights',
  ...
  'Return Policy': {
    ...
    sections: [
      {
        heading: 'Digital Products and Returns',
        body: 'QuickSub sells digitally delivered subscriptions and gaming top-ups, so completed products cannot be physically returned. Please check the product, package, account email, player ID, region, and device requirements before payment.',
      },
      {
        heading: 'Before Delivery',
        body: 'If fulfillment has not started, contact support immediately with your order ID. We will check whether the order can be cancelled or changed. A change is not guaranteed after payment verification or processing begins.',
      },
      {
        heading: 'Incorrect, Duplicate, or Failed Delivery',
        body: 'Contact support within 48 hours if the wrong product was delivered, delivery failed despite correct customer details, or you were charged twice. Keep the order receipt and payment proof so the team can investigate.',
      },
      {
        heading: 'Completed and Activated Orders',
        body: 'A correctly delivered or activated digital product is not returnable. Problems caused by an incorrect player ID, account detail, region, device incompatibility, change of mind, or a third-party account restriction are not eligible for return.',
      },
      {
        heading: 'Resolution',
        body: 'When a claim is approved, QuickSub may correct the delivery, replace the product where possible, issue store credit, or provide a refund under the Refund Policy. The available resolution depends on the product provider and order status.',
      },
    ],
  },
  'Delivery Policy': {
  ...
  'Cookie Policy': {
    ...
    sections: [
      {
        heading: 'What We Use',
        body: 'QuickSub uses browser local storage to remember your saved products (favorites) and cookie consent preference. Essential HTTP-only cookies keep customer and admin sessions signed in. Signing out invalidates the corresponding session. We do not use third-party advertising or analytics tracking cookies.',
      },
      {
