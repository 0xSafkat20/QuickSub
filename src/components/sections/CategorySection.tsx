...
const categoryData = [
  {
    ...
    label: 'All Products',
    icon: Layers,
    description: 'Browse all 13 QuickSub products — streaming, gaming top-ups, and AI tools in one organized store.',
  ...
  },
  {
    ...
    label: 'Streaming',
    icon: Tv,
    description: 'Netflix, Disney+ Hotstar, and YouTube Premium — movies, series, originals, and live sports.',
  ...
  },
  {
    ...
    label: 'Gaming Top-Up',
    icon: Gamepad2,
    description: 'PUBG UC, Freefire Diamonds, Valorant VP, Mobile Legends, and eFootball — all top-ups delivered fast.',
    highlight: 'Level Up',
    color: '#F59E0B',
    bgLight: '#FFFBEB',
    bgDark: '#FDE68A',
