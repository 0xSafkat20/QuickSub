...
const categoryData = [
  {
    ...
    label: 'All Products',
    icon: Layers,
    description: 'Browse all 21 QuickSub products — streaming, gaming top-ups, and AI tools in one organized store.',
  ...
  },
  {
    ...
    label: 'Streaming',
    icon: Tv,
    description: 'Netflix, Disney+ Hotstar, YouTube Premium, and Amazon Prime Video — movies, originals, and live sports.',
  ...
  },
  {
    ...
    label: 'Music',
    icon: Music,
    description: 'Spotify Premium and Apple Music — ad-free songs, lossless audio, podcasts, and offline playlists.',
  ...
  },
  {
    ...
    label: 'Gaming Top-Up',
    icon: Gamepad2,
    description: 'PUBG UC, Freefire Diamonds, Valorant VP, Mobile Legends, CoC Gems, Robux, and eFootball — all top-ups delivered fast.',
    highlight: 'Level Up',
    color: '#F59E0B',
    bgLight: '#FFFBEB',
    bgDark: '#FDE68A',
  },
  {
    ...
    label: 'AI Tools',
    icon: Bot,
    description: 'ChatGPT, QuillBot, Canva Pro, Midjourney, Notion AI, Grammarly, and Adobe CC — AI for every workflow.',
